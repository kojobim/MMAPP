...
public class InversionesServicioTest {
	...
	public void inversionesAltaPagarTestDeberiaSerExitoso() {
		...
		datosInversionAltaPagar.addProperty("Inv_Numero", "001953830058006");
		datosInversionAltaPagar.addProperty("Inv_FecIni", "2020-02-17 00:00:00");
		...
		datosInversionAltaPagar.addProperty("Fecha", "2020-02-17 00:00:00");
