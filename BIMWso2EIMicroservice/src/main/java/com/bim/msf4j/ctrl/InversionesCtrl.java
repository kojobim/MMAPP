...
public class InversionesCtrl extends BimBaseCtrl {
	...
	public Response reinversion(@PathParam("invNumero") String invNumero,	
		...
		/**
		 * REGLA DE NEGOCIO: verifica que la cantidad de inversiÃ³n en UDIS sea menor a 400,000.00 para calcular GAT y GATReal
		 */
		...
		/**
		 * REGLA DE NEGOCIO: EnvÃ­o de correo con plantilla establecida por BIM y encriptado de digito verificador
		 */
	...
	public Response calculadora(@QueryParam("monto") String monto, 
		...
		// Inicia declaraciÃ³n de variables
